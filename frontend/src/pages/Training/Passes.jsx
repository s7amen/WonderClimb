...
const TrainingPasses = () => {
    ...
    const handleSave = async (arg1, arg2) => {
        setIsSaving(true);

        try {
            if (editingPass) {
                // Edit mode: arg1 is ID, arg2 is data
                await trainingAPI.updatePass(arg1, arg2);
                showToast('Картата е обновена успешно', 'success');
            } else {
                // Create mode: arg1 is data
                await trainingAPI.createPass(arg1);
    ...
    return (
        <div className="space-y-6">{/* Header */}
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-medium text-neutral-950">Карти за тренировки</h1>
                </div>
                {isAdmin && (
                                ...
                                passes.map((pass) => {
                                    ...
                                    return (
                                        <tr key={pass._id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {pass.remainingSessions !== null && pass.totalSessions !== null
