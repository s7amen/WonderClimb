...
# We use node:20-slim as the base for building and installing dependencies.
...
# We use node:20-slim-buster (or node:20-slim-bullseye, or similar) as a minimal runtime image.
FROM node:20-slim
